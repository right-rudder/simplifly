  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "airline-cockpit":
          "url('airline-pilot-courses-at-simplifly-flight-school.webp')",
        canyon: "url('canyon-background.webp')",
        "cfi-pass": "url('cfi-pass.webp')",
        "planes-parked":
          "url('multi-engine-airplane-flying-over-mesa-az.webp')",
        skyline: "url('skyline.webp')",
        streaking: "url('airplane-streaking-by-a-runway-in-mesa-az.webp')",
